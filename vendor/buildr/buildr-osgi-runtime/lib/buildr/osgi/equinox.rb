...
# Equinox settings
##############################
eclipse.product=Jamex
eclipse.ignoreApp=true
osgi.syspath=.
osgi.clean=true
osgi.startLevel=#{Bundle::MAX_RUN_LEVEL}
osgi.bundles.defaultStartLevel=#{Bundle::DEFAULT_RUN_LEVEL}
...
java.io.tmpdir=tmp
#java.util.logging.properties=conf/java.util.logging.properties
...
osgi.bundles= \\
CONFIG
        s = self.runtime.bundles.select{|b| b.enable?}.collect do |bundle|
